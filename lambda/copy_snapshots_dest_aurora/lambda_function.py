...
def lambda_handler(event, context):
    ...
    shared_snapshots = get_shared_snapshots(SNAPSHOT_PATTERN, response)
    own_snapshots = get_own_snapshots_dest(SNAPSHOT_PATTERN, response)
    ...
    own_dest_snapshots = get_own_snapshots_dest(SNAPSHOT_PATTERN, response_dest)

    logger.info(own_snapshots)
    logger.info(own_dest_snapshots)
